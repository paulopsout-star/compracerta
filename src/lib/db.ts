...
// Trim defensivo: env vars criadas via `echo` na Vercel CLI ficam com \n final,
// o que quebra silenciosamente o createClient (URL inválida não throws, apenas
// retorna objetos que fazem no-op).
