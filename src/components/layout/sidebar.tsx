      ...
      <div className="px-6 pt-8 pb-6">
        <div className="flex items-center gap-3">
          {branding.logoUrl ? (
            ...
            <div className="flex items-center justify-center w-10 h-10 rounded-[10px] bg-[var(--sidebar-primary)] text-white shrink-0">
          ...
          <div className="min-w-0">
            <p className="text-[16px] font-bold text-[#111827] leading-tight truncate">{branding.appName}</p>
            {branding.tagline && (
              <p className="text-[11px] text-[#9AA0AB] font-medium truncate">{branding.tagline}</p>
            )}
          </div>
        </div>
      </div>
