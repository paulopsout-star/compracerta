...
const INTEGRATIONS = [
  { name: "Canal do Repasse (Marketplace)", desc: "Webhook + REST API para anúncios ativos", icon: Wifi, status: "online", latency: "45ms" },
  { name: "Avaliador Digital (Read Replica)", desc: "CDC / Read Replica para veículos em avaliação", icon: Database, status: "pendente", latency: "—" },
